...
# load in the data
df = pd.read_csv('/Users/moncefarajdal/Downloads/ml-20m/edited_rating.csv')
...
A = A.tocsr()
mask = (A > 0)
save_npz("/Users/moncefarajdal/Downloads/ml-20m/Atrain.npz", A)
...
A_test = A_test.tocsr()
mask_test = (A_test > 0)
save_npz("/Users/moncefarajdal/Downloads/ml-20m/Atest.npz", A_test)
